...
public class Main {
	...
	public static void main(String[] args) {
		...
		Entity memberTunahan = new Member("Tunahan Berber","Türk","123456","tunahanberber123@gmail.com",true);
		...
		Entity memberFatmanur = new Member("Fatmanur Sevindik","Türk","1234567","fatmanursevindik123@gmail.com",true);
